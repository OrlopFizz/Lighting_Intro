...
glm::mat4 fpv_camera::get_projection_matrix(float win_width, float win_height) {
	return glm::perspective(glm::radians(45.0f), (float)(win_width / win_height), 0.1f, 1000.0f);
}
